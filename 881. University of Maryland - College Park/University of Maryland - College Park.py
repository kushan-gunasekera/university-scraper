...
MAIN_DOMAIN = 'https://academiccatalog.umd.edu'
UNIVERSITY = 'University of Maryland - College Park'


def get_courses():
    r = requests.get(f'{MAIN_DOMAIN}/undergraduate/approved-courses/', headers=HEADERS)
...
def get_course(url):
    ...
    for tag in div_tags:
        ...
        desc = tag.find('p', class_='courseblockdesc noindent')
        if desc:
