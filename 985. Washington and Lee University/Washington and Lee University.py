...
MAIN_DOMAIN_1 = 'https://catalog.wlu.edu/content.php?catoid=41&catoid=41&navoid=4009&filter%5Bitem_type%5D=3&filter%5Bonly_active%5D=1&filter%5B3%5D=1&filter%5Bcpage%5D={page_number}#acalog_template_course_filter'
MAIN_DOMAIN_2 = 'https://catalog.wlu.edu/content.php?catoid=42&catoid=42&navoid=4085&filter%5Bitem_type%5D=3&filter%5Bonly_active%5D=1&filter%5B3%5D=1&filter%5Bcpage%5D={page_number}#acalog_template_course_filter'
...
def get_courses(domain, page_number):
    ...
    for tag in course_tags:
        ...
        if len(tag_split) == 2:
            ...
            title = tag_split[1]
            desc = None
            url = f'http://catalog.wlu.edu/{tag.get("href")}'
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=100) as executor:
        for i in as_completed(executor.submit(get_courses, MAIN_DOMAIN_1, page_number) for page_number in range(1, 21)):
