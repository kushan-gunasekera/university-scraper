...
uniqueSessionId = 'hd0jr1720260005760'
cookie = 'JSESSIONID=CD74827C0C1BDF91A3B54CF8246B1418; GCLB=CO283tryrdfQahAD'


def get_terms():
    url = 'https://bn-reg.uis.georgetown.edu/StudentRegistrationSsb/ssb/courseSearch/getTerms'
    params = {
        'searchTerm': '',
        'offset': '1',
        'max': '1000',
...
def get_courses(term):
    ...
    url = 'https://bn-reg.uis.georgetown.edu/StudentRegistrationSsb/ssb/courseSearchResults/courseSearchResults'
    headers = {
        'accept': 'application/json, text/javascript, */*; q=0.01',
        'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8,si;q=0.7',
        'cookie': cookie,
