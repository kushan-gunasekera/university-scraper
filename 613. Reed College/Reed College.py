...
MAIN_DOMAIN_1 = 'https://catalog.reed.edu/content.php?catoid=9&catoid=9&navoid=785&filter%5Bitem_type%5D=3&filter%5Bonly_active%5D=1&filter%5B3%5D=1&filter%5Bcpage%5D={page_number}#acalog_template_course_filter'
...
def get_courses(domain, page_number):
    ...
    for tag in course_tags:
        ...
        if len(tag_split) == 2:
            ...
            title = tag_split[1]
            desc = None
            url = f'http://catalog.reed.edu/{tag.get("href")}'
            # url = 'https://catalog.reed.edu/preview_course_nopop.php?catoid=9&coid=7734'
