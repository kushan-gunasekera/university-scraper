...
UNIVERSITY = 'Binghampton University SUNY'
uniqueSessionId = 'lp71a1720268299023'
cookie = 'JSESSIONID=BF72FC216681CC2F7D9BF9DB58A72A1D.b6_cat_2'
HEADERS = {'Cookie': cookie}

all_codes = []
old_courses = {}
try:
    with open(f'{UNIVERSITY}.json', 'r') as f:
...
def get_terms():
    url = 'https://ssb.cc.binghamton.edu:8484/StudentRegistrationSsb/ssb/courseSearch/getTerms'
    params = {
        'searchTerm': '',
        'offset': '1',
        'max': '1000',
...
def get_courses(term):
    def format_response(response):
        ...
        for count, i in enumerate(response, 1):
            ...
            if code in all_codes:
                ...
                continue
            url = 'https://ssb.cc.binghamton.edu:8484/StudentRegistrationSsb/ssb/searchResults'
            data = {
                'term': i.get('term'),
    ...
    url = 'https://ssb.cc.binghamton.edu:8484/StudentRegistrationSsb/ssb/searchResults/searchResults'
    params = {
        'txt_term': term,
        'startDatepicker': '',
        'endDatepicker': '',
