...
HEADERS = {
    ...
    'Origin': 'http://coursecatalog.web.cmu.edu',
    'Referer': 'http://coursecatalog.web.cmu.edu/course-search/',
...
def get_description(code, key, srcdb):
    ...
    url = 'http://coursecatalog.web.cmu.edu/course-search/api/?page=fose&route=details'
...
def get_course(character):
    ...
    data = {
        "other": {"srcdb": ""},
        "criteria": [{"field": "keyword", "value": character}]
    }
    url = f'http://coursecatalog.web.cmu.edu/course-search/api/?page=fose&route=search&keyword={character}'
    r = requests.post(url, headers=HEADERS, json=data, verify=False)
    courses = {}
